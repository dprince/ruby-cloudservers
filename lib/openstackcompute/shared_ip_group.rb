module OpenStackCompute
  class SharedIPGroup
    ...
    # by the get_shared_ip_group method on a OpenStackCompute::Connection object.
    #
    #   >> sig = cs.get_shared_ip_group(127)
    #   => #<OpenStackCompute::SharedIPGroup:0x101513798 ...>
    #   >> sig.name
    #   => "New Group"
    ...
    # Makes the API call that populates the OpenStackCompute::SharedIPGroup object with information on the group.  Can also be called directly on
