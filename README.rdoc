...
Ruby Openstack binding based on the Rackspace Cloud API.
...
See the class definitions for documentation on specific methods and operations.
  ...
  cs = CloudServers::Connection.new(:username => USERNAME, :api_key => API_KEY, :api_url => API_URL)	
...
Based on the Rackspace Cloud API by Wade Mintor and Mike Mayo.
